                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostSpaceDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewSpacePostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewSpacePostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewSpacePostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostSpaceDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostSpaceDetailPage({required this.post});

  @override
  _PostSpaceDetailPageState createState() => _PostSpaceDetailPageState();
}

class _PostSpaceDetailPageState extends State<PostSpaceDetailPage> {
