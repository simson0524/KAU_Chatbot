                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostSoftwareDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewSoftwarePostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewSoftwarePostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewSoftwarePostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostSoftwareDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostSoftwareDetailPage({required this.post});

  @override
  _PostSoftwareDetailPageState createState() => _PostSoftwareDetailPageState();
}

class _PostSoftwareDetailPageState extends State<PostSoftwareDetailPage> {
