                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostBusinessDetailPage(
...
// 글 상세 페이지
class PostBusinessDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostBusinessDetailPage({required this.post});

  @override
  _PostBusinessDetailPageState createState() => _PostBusinessDetailPageState();
}

class _PostBusinessDetailPageState extends State<PostBusinessDetailPage> {
