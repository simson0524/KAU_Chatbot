                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostMaterialDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewMaterialPostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewMaterialPostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewMaterialPostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostMaterialDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostMaterialDetailPage({required this.post});

  @override
  _PostMaterialDetailPageState createState() => _PostMaterialDetailPageState();
}

class _PostMaterialDetailPageState extends State<PostMaterialDetailPage> {
