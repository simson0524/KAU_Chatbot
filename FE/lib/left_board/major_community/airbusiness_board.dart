                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostAirbusinessDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewAirbusinessPostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewAirbusinessPostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewAirbusinessPostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostAirbusinessDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostAirbusinessDetailPage({required this.post});

  @override
  _PostAirbusinessDetailPageState createState() =>
      _PostAirbusinessDetailPageState();
}

class _PostAirbusinessDetailPageState extends State<PostAirbusinessDetailPage> {
