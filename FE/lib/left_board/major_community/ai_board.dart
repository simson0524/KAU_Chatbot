                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostAiDetailPage(
...
// 글 등록 페이지
class NewAiPostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewAiPostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostAiDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostAiDetailPage({required this.post});

  @override
  _PostAiDetailPageState createState() => _PostAiDetailPageState();
}

class _PostAiDetailPageState extends State<PostAiDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0.0,
        title: Text('AI시스템자율공학과 게시판', style: TextStyle(color: Colors.black)),
        centerTitle: true,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Colors.black),
          onPressed: () => Navigator.pop(context),
