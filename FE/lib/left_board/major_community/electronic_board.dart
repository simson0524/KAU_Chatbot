                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostElectronicDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewElectronicPostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewElectronicPostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewElectronicPostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostElectronicDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostElectronicDetailPage({required this.post});

  @override
  _PostElectronicDetailPageState createState() =>
      _PostElectronicDetailPageState();
}

class _PostElectronicDetailPageState extends State<PostElectronicDetailPage> {
