                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostComputerDetailPage(
...
// 글 상세 페이지
class PostComputerDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostComputerDetailPage({required this.post});

  @override
  _PostComputerDetailPageState createState() => _PostComputerDetailPageState();
}

class _PostComputerDetailPageState extends State<PostComputerDetailPage> {
