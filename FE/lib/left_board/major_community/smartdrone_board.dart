                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostSmartdroneDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewSmartdronePostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewSmartdronePostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewSmartdronePostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostSmartdroneDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostSmartdroneDetailPage({required this.post});

  @override
  _PostSmartdroneDetailPageState createState() =>
      _PostSmartdroneDetailPageState();
}

class _PostSmartdroneDetailPageState extends State<PostSmartdroneDetailPage> {
