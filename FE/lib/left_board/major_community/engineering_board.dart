                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostEngineeringDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewEngineeringPostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewEngineeringPostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewEngineeringPostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostEngineeringDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostEngineeringDetailPage({required this.post});

  @override
  _PostEngineeringDetailPageState createState() =>
      _PostEngineeringDetailPageState();
}

class _PostEngineeringDetailPageState extends State<PostEngineeringDetailPage> {
