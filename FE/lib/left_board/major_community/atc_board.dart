                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostAtcDetailPage(
...
// 글 상세 페이지
class PostAtcDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostAtcDetailPage({required this.post});

  @override
  _PostAtcDetailPageState createState() => _PostAtcDetailPageState();
}

class _PostAtcDetailPageState extends State<PostAtcDetailPage> {
