  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('항공교통물류학과 게시판', style: TextStyle(color: Colors.black)),
        centerTitle: true,
        leading: IconButton(
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AtcPostDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewAtcPostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewAtcPostPage extends StatelessWidget {
  final Function(String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewAtcPostPage({required this.onAddPost});
...
// 글 상세 페이지
class AtcPostDetailPage extends StatefulWidget {
  final Map<String, String> post;

  AtcPostDetailPage({required this.post});

  @override
  _AtcPostDetailPageState createState() => _AtcPostDetailPageState();
}

class _AtcPostDetailPageState extends State<AtcPostDetailPage> {
