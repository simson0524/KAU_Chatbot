  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('자유전공학과 게시판', style: TextStyle(color: Colors.black)),
        centerTitle: true,
        leading: IconButton(
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostUndeclaredDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewUndeclaredPostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewUndeclaredPostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewUndeclaredPostPage({required this.onAddPost});
...
// 글 상세 페이지
class PostUndeclaredDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostUndeclaredDetailPage({required this.post});

  @override
  _PostUndeclaredDetailPageState createState() =>
      _PostUndeclaredDetailPageState();
}

class _PostUndeclaredDetailPageState extends State<PostUndeclaredDetailPage> {
