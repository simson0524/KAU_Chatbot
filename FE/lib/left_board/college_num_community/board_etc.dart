...
// 게시판 화면
class BoardEtcPage extends StatefulWidget {
  @override
  _BoardEtcPageState createState() => _BoardEtcPageState();
}

class _BoardEtcPageState extends State<BoardEtcPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('기타학번 게시판', style: TextStyle(color: Colors.black)),
        centerTitle: true,
        leading: IconButton(
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => PostEtcDetailPage(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NewEtcPostPage(
                        onAddPost: addPost,
                      ),
                    ),
                  );
...
// 글 등록 페이지
class NewEtcPostPage extends StatelessWidget {
  final Function(String, String, String) onAddPost;
  final TextEditingController titleController = TextEditingController();
  final TextEditingController contentController = TextEditingController();

  NewEtcPostPage({required this.onAddPost});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0.0,
        title: Text('Etc학번 게시판', style: TextStyle(color: Colors.black)),
        centerTitle: true,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Colors.black),
          onPressed: () => Navigator.pop(context),
...
// 글 상세 페이지
class PostEtcDetailPage extends StatefulWidget {
  final Map<String, String> post;

  PostEtcDetailPage({required this.post});

  @override
  _PostEtcDetailPageState createState() => _PostEtcDetailPageState();
}

class _PostEtcDetailPageState extends State<PostEtcDetailPage> {
